  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl px-4 text-center">
        <h1 className="text-white font-bold text-[20px] sm:text-[26px] md:text-[32px] leading-snug mb-6">
          {slides[current].text}
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="#comptes"
            className="bg-mujec-gold text-mujec-dark px-6 py-3 rounded-full font-bold text-subtitle hover:scale-105 transition"
          >
            Ouvrir un Compte
          </a>
          ...
          <a
            href="#services"
            className="border border-white text-white px-6 py-3 rounded-full text-subtitle hover:bg-white/20 transition"
          >
            Nos Services
          </a>
        </div>
